class PostAttachmentsController < ApplicationController
  ...
  before_action :post_attachment_correct_user, only: [:edit, :update, :destroy]
  ...
  private
    ...
    def post_attachment_correct_user
      post_attachment = current_user.post_attachments.find(params[:id])
      redirect_to root_url if post_attachment.nil?
    end
end
